...
# Publications #
 + Tong Zhang, **Qianren Li**, Shuai Wang, Wanli Ni, Jiliang Zhang, Rui Wang, Kai-Kit Wong, Chan-Byoung Chae, "[Indoor Fluid Antenna Systems Enabled by Layout-Specific Modeling and Group Relative Policy Optimization](https://arxiv.org/abs/2509.15006)," **IEEE Transactions on Wireless Communications**, doi: 10.1109/TWC.2025.3646155.
 + **Qianren Li**, Yuncong Hong, Bojie Lv, and Rui Wang, "[A Dynamic Programming Framework for Vehicular Task Offloading with Successive Action Improvement](https://arxiv.org/abs/2509.05907)," **IEEE Transactions on Communications**, doi: 10.1109/TCOMM.2025.3610216.
